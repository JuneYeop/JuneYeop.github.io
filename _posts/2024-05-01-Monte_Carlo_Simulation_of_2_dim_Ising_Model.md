...
Before we preceed, we should set up a strategy how to discribe this system numerically.



---

#### **2.  Evolutions of spin-configuration and magnetization w.r.t. iteration**
...
Let us begin the code with "PROGRAM ~" as usual.
...
   
   
Declare the names of variables. 
